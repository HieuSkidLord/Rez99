...
local Window = Rayfield:CreateWindow({
   Name = "Rez Hub [99 night with Loli in the forest]",
   Icon = 0, -- Icon in Topbar. Can use Lucide Icons (string) or Roblox Image (number). 0 to use no icon (default).
   LoadingTitle = "99 night in the forest",
   LoadingSubtitle = "by rez",
   ...
   Discord = {
      ...
      Invite = "https://discord.gg/d5Fz9NkF", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ ABCD would be ABCD
